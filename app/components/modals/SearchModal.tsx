...
const SearchModal = () => {
  ...
  const [location, setLocation] = useState<SaudiCityValue>();
  ...
  let bodyContent = (
    <div className="flex flex-col gap-8">
      <Heading
        ...
        subtitle="ابحث عن المدينة المناسبة!"
      />
      <CitySelect 
        value={location} 
        onChange={(value) => 
          setLocation(value as SaudiCityValue)} 
      />
      <hr />
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="تأكد من أن الجميع متفرغ!"
        />
        <Calendar
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="ابحث عن المكان المثالي!"
        />
        <Counter 
          onChange={(value) => setGuestCount(value)}
          value={guestCount}
          title="ضيوف" 
          subtitle="كم عدد الضيوف الذين سيأتون؟"
        />
        <hr />
        <Counter 
